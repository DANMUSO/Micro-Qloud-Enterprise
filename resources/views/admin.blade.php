						...
						<div class="card-header">
						  ...
						  <div class="card-body">
							<div class="d-flex align-items-center ms-auto font-13 gap-2 mb-3">
								<span class="border px-1 rounded cursor-pointer"><i class="bx bxs-circle me-1" style="color: #009E60"></i>Payment</span>
								<span class="border px-1 rounded cursor-pointer"><i class="bx bxs-circle me-1" style="color: #ffa500"></i>Disbursement</span>
							</div>
...
gradientStroke1.addColorStop(0, '#009E60');  
gradientStroke1.addColorStop(1, '#009E60'); 
